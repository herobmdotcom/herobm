...
replaceFile('apps/ops-portal/app/admin/settings/financial/ImportCoaModal.tsx', [
    ['{ body: JSON.stringify({ preset }) }', '{ preset } as any']
]);
...
replaceFile('apps/ops-portal/app/admin/settings/financial/page.tsx', [
    ...
    ['accountMetadataSchema:', '// accountMetadataSchema:'], // Wait, line 159: `setSchemaObj((glSettings as any)?.accountMetadataSchema ||`
    ['{ body: JSON.stringify(payload) }', 'payload as any'],
...
replaceFile('apps/ops-portal/app/admin/settings/system/page.tsx', [
    ['{ body: JSON.stringify(body) }', 'body as any'],
...
console.log("Fixed admin settings 2");
