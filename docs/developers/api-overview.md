...
| Method | Endpoint | Description |
| :--- | :--- | :--- |
| `POST` | `/crm-activities` | Create CRM Activity |
| `GET` | `/crm-activities` | List CRM Activities |
| `GET` | `/crm-activities/{id}` | Get CRM Activity |
...
| `POST` | `/opportunities/{id}/archive` | Archive Opportunity |
| `POST` | `/opportunities/{id}/unarchive` | Unarchive Opportunity |
| `POST` | `/opportunities/{id}/notes` | Add Opportunity Note |
...
| `POST` | `/products/{id}/copy` | Copy Product |
...
| Method | Endpoint | Description |
| :--- | :--- | :--- |
| `GET` | `/storage/images/{path}` | Stream Storage Image |
| `DELETE` | `/storage/images/{path}` | Delete Storage Image |
| `POST` | `/storage/images` | Upload Storage Image |
| `GET` | `/storage/images` | List Storage Images |
...
| `POST` | `/settings/organization/logo` | Upload Organization Logo |
| `DELETE` | `/settings/organization/logo` | Remove Organization Logo |
| `GET` | `/settings/organization/logo` | Stream Organization Logo |
