---
id: tech-schema-reference
title: "PostgreSQL Database Schema Reference"
description: "Comprehensive schema reference for herobm_core: tables, column definitions, data types, indexes, and foreign keys."
...
routes:
  - "/admin/settings"
tags: ["database", "schema", "tables", "columns", "postgres", "drizzle", "herobm_core"]
related:
  - "tech-database-architecture"
  - "tech-database-migrations"
---

# Schema Reference — `herobm_core`

> Auto-generated from live Postgres introspection. Last generated: 2026-08-24 19:18 UTC
...
| [`actor_contact_links`](#actor_contact_links) | 2,153 | `link_id` | |
| [`actor_notes`](#actor_notes) | 0 | `note_id` | |
| [`actors`](#actors) | 2,122 | `actor_id` | |
...
| [`bin_contents`](#bin_contents) | 2,363 | `bin_content_id` | |
| [`bins`](#bins) | 0 | `bin_id` | |
...
| [`gl_accounts`](#gl_accounts) | 253 | `gl_account_id` | |
| [`gl_fiscal_periods`](#gl_fiscal_periods) | 12 | `period_id` | |
| [`gl_journal_entries`](#gl_journal_entries) | 1 | `journal_entry_id` | |
...
| [`goods_received`](#goods_received) | 6,777 | `goods_received_id` | |
| [`goods_received_lines`](#goods_received_lines) | 35,115 | `goods_received_line_id` | |
| [`group_events`](#group_events) | 3 | `event_id` | |
| [`import_abm_sales_quotes`](#import_abm_sales_quotes) | 31 | — | |
| [`integration_events`](#integration_events) | 0 | `event_id` | |
| [`integrations`](#integrations) | 0 | `integration_id` | |
| [`inventory_entries`](#inventory_entries) | 3,450 | `entry_id` | |
| [`inventory_events`](#inventory_events) | 0 | `event_id` | |
| [`inventory_ledger`](#inventory_ledger) | 2,378 | `ledger_id` | |
| [`locations`](#locations) | 0 | `location_id` | |
| [`macros`](#macros) | 0 | `macro_id` | |
| [`master_data_events`](#master_data_events) | 40 | `event_id` | |
| [`organization`](#organization) | 0 | `organization_id` | |
| [`outbox`](#outbox) | 45 | `outbox_id` | |
| [`payment_allocations`](#payment_allocations) | 56,240 | `allocation_id` | |
| [`payment_entries`](#payment_entries) | 35,663 | `payment_id` | |
...
| [`procurement_events`](#procurement_events) | 2 | `event_id` | |
...
| [`product_uoms`](#product_uoms) | 18,000 | `product_uom_id` | |
| [`products`](#products) | 18,001 | `product_id` | |
...
| [`purchase_debit_note_lines`](#purchase_debit_note_lines) | 1,206 | `debit_note_line_id` | |
| [`purchase_debit_note_shipments`](#purchase_debit_note_shipments) | 0 | `debit_note_shipment_id` | |
| [`purchase_debit_notes`](#purchase_debit_notes) | 869 | `debit_note_id` | |
| [`purchase_invoice_lines`](#purchase_invoice_lines) | 80,855 | `invoice_line_id` | |
| [`purchase_invoice_receipts`](#purchase_invoice_receipts) | 0 | `invoice_receipt_id` | |
| [`purchase_invoices`](#purchase_invoices) | 31,345 | `invoice_id` | |
| [`purchase_order_lines`](#purchase_order_lines) | 32,339 | `purchase_order_line_id` | |
| [`purchase_order_return_lines`](#purchase_order_return_lines) | 1,090 | `return_line_id` | |
...
| [`purchase_order_returns`](#purchase_order_returns) | 749 | `return_id` | |
| [`purchase_orders`](#purchase_orders) | 6,149 | `purchase_order_id` | |
| [`reconciliation_events`](#reconciliation_events) | 0 | `event_id` | |
| [`reconciliation_rules`](#reconciliation_rules) | 0 | `rule_id` | |
| [`sales_credit_note_lines`](#sales_credit_note_lines) | 3,784 | `credit_note_line_id` | |
| [`sales_credit_notes`](#sales_credit_notes) | 980 | `credit_note_id` | |
| [`sales_events`](#sales_events) | 59 | `event_id` | |
| [`sales_invoice_lines`](#sales_invoice_lines) | 169,137 | `invoice_line_id` | |
| [`sales_invoices`](#sales_invoices) | 26,054 | `invoice_id` | |
| [`sales_order_lines`](#sales_order_lines) | 172,592 | `sales_order_line_id` | |
| [`sales_order_picks`](#sales_order_picks) | 0 | `pick_id` | |
| [`sales_order_return_lines`](#sales_order_return_lines) | 3,437 | `return_line_id` | |
| [`sales_order_returns`](#sales_order_returns) | 622 | `return_id` | |
| [`sales_order_shipment_lines`](#sales_order_shipment_lines) | 80,974 | `shipment_line_id` | |
| [`sales_order_shipments`](#sales_order_shipments) | 8,802 | `shipment_id` | |
| [`sales_orders`](#sales_orders) | 10,299 | `sales_order_id` | |
| [`schema_migrations`](#schema_migrations) | 3 | `filename` | |
| [`supplier_expiries`](#supplier_expiries) | 0 | `expiry_id` | |
| [`supplier_groups`](#supplier_groups) | 0 | `supplier_group_id` | |
| [`suppliers`](#suppliers) | 637 | `vendor_id` | |
| [`system_events`](#system_events) | 10 | `event_id` | |
...
| [`transfer_order_lines`](#transfer_order_lines) | 2,275 | `transfer_order_line_id` | |
...
| [`user_events`](#user_events) | 1 | `event_id` | |
| [`user_settings`](#user_settings) | 0 | `user_id` | |
| [`user_two_factor`](#user_two_factor) | 1 | `user_id` | |
...
| [`work_orders`](#work_orders) | 183 | `work_order_id` | |
...
| `user_two_factor` | `user_id` | `users` | `user_id` |
...
graph LR
    ...
    gl_fiscal_periods["gl_fiscal_periods"]
...
### `herobm_core.actor_contact_links` (2,153 rows)
...
### `herobm_core.bin_contents` (2,363 rows)
...
### `herobm_core.contacts` (2,334 rows)
...
### `herobm_core.customer_delivery_addresses` (1,852 rows)
...
### `herobm_core.customers` (1,551 rows)
...
### `herobm_core.gl_accounts` (253 rows)
...
### `herobm_core.gl_fiscal_periods` (12 rows)

| # | Column | Type | Nullable | Default | Constraints |
|---|--------|------|----------|---------|------------|
| 1 | `period_id` | `uuid` |  | gen_random_uuid() | 🔑 PK |
| 2 | `period_name` | `text` |  |  | UNIQUE |
| 3 | `fiscal_year` | `int4` |  |  |  |
| 4 | `period_number` | `int4` |  |  |  |
| 5 | `start_date` | `date` |  |  |  |
| 6 | `end_date` | `date` |  |  |  |
| 7 | `status` | `text` |  |  |  |
| 8 | `locked_by` | `text` | ✓ |  |  |
| 9 | `locked_at` | `timestamptz` | ✓ |  |  |
| 10 | `closed_by` | `text` | ✓ |  |  |
| 11 | `closed_at` | `timestamptz` | ✓ |  |  |
| 12 | `notes` | `text` | ✓ |  |  |
| 13 | `created_on` | `timestamptz` | ✓ | now() |  |
| 14 | `modified_on` | `timestamptz` | ✓ | now() |  |

### `herobm_core.gl_journal_entries` (1 rows)
...
### `herobm_core.goods_received` (6,777 rows)
...
### `herobm_core.goods_received_lines` (35,115 rows)
...
### `herobm_core.group_events` (3 rows)
...
### `herobm_core.import_abm_sales_quotes` (31 rows)
...
### `herobm_core.inventory_entries` (3,450 rows)
...
### `herobm_core.inventory_ledger` (2,378 rows)
...
### `herobm_core.master_data_events` (40 rows)
...
### `herobm_core.payment_allocations` (56,240 rows)
...
### `herobm_core.payment_entries` (35,663 rows)
...
### `herobm_core.procurement_events` (2 rows)
...
### `herobm_core.product_components` (215 rows)
...
### `herobm_core.product_uoms` (18,000 rows)
...
### `herobm_core.products` (18,001 rows)
...
### `herobm_core.purchase_debit_note_lines` (1,206 rows)
...
### `herobm_core.purchase_debit_notes` (869 rows)
...
### `herobm_core.purchase_invoice_lines` (80,855 rows)
...
### `herobm_core.purchase_invoices` (31,345 rows)
...
### `herobm_core.purchase_order_lines` (32,339 rows)
...
### `herobm_core.purchase_order_return_lines` (1,090 rows)
...
### `herobm_core.purchase_order_returns` (749 rows)
...
### `herobm_core.purchase_orders` (6,149 rows)
...
### `herobm_core.sales_credit_note_lines` (3,784 rows)
...
### `herobm_core.sales_credit_notes` (980 rows)
...
### `herobm_core.sales_events` (59 rows)
...
### `herobm_core.sales_invoice_lines` (169,137 rows)
...
### `herobm_core.sales_invoices` (26,054 rows)
...
### `herobm_core.sales_order_lines` (172,592 rows)
...
### `herobm_core.sales_order_return_lines` (3,437 rows)
...
### `herobm_core.sales_order_returns` (622 rows)
...
### `herobm_core.sales_order_shipment_lines` (80,974 rows)
...
### `herobm_core.sales_order_shipments` (8,802 rows)
...
### `herobm_core.sales_orders` (10,299 rows)
...
### `herobm_core.schema_migrations` (3 rows)
...
### `herobm_core.suppliers` (637 rows)
...
### `herobm_core.system_events` (10 rows)
...
### `herobm_core.transfer_order_lines` (2,275 rows)
...
### `herobm_core.transfer_orders` (174 rows)
...
### `herobm_core.user_events` (1 rows)
...
### `herobm_core.user_two_factor` (1 rows)

| # | Column | Type | Nullable | Default | Constraints |
|---|--------|------|----------|---------|------------|
| 1 | `user_id` | `uuid` |  |  | FK → users.user_id, 🔑 PK |
| 2 | `secret_encrypted` | `text` |  |  |  |
| 3 | `is_enabled` | `bool` |  |  |  |
| 4 | `backup_codes` | `jsonb` |  |  |  |
...
### `herobm_core.work_order_components` (13 rows)
...
### `herobm_core.work_orders` (183 rows)
