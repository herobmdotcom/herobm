...
| [`purchase_order_returns`](#purchase_order_returns) | 744 | `return_id` | |
...
### `herobm_core.goods_received` (6,732 rows)
...
### `herobm_core.goods_received_lines` (34,924 rows)
...
### `herobm_core.payment_allocations` (55,962 rows)
...
### `herobm_core.purchase_order_return_lines` (1,084 rows)
...
### `herobm_core.purchase_order_returns` (744 rows)
...
### `herobm_core.purchase_orders` (6,405 rows)
...
### `herobm_core.sales_events` (27,608 rows)
...
### `herobm_core.sales_invoices` (25,936 rows)
...
### `herobm_core.sales_order_return_lines` (3,260 rows)
...
### `herobm_core.sales_order_shipments` (8,742 rows)
...
### `herobm_core.sales_orders` (27,608 rows)
