...
export const PURCHASE_ORDER_TRANSITIONS: Record<string, string[]> = {
  ...
  [PURCHASE_ORDER_STATE.PARTIALLY_RECEIVED]: [PURCHASE_ORDER_STATE.RECEIVED, PURCHASE_ORDER_STATE.CLOSED_SHORT],
  [PURCHASE_ORDER_STATE.RECEIVED]: [PURCHASE_ORDER_STATE.INVOICED, PURCHASE_ORDER_STATE.PARTIALLY_RECEIVED],
