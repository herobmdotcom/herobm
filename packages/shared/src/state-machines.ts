...
export const PURCHASE_ORDER_TRANSITIONS: Record<string, string[]> = {
  ...
  [PURCHASE_ORDER_STATE.LEGACY]: [PURCHASE_ORDER_STATE.PARTIALLY_RECEIVED, PURCHASE_ORDER_STATE.RECEIVED, PURCHASE_ORDER_STATE.INVOICED, PURCHASE_ORDER_STATE.CLOSED_SHORT, PURCHASE_ORDER_STATE.CANCELLED],
...
export const TRANSFER_ORDER_TRANSITIONS: Record<string, string[]> = {
  ...
  [TRANSFER_ORDER_STATE.SHIPPED]: [TRANSFER_ORDER_STATE.RECEIVED, TRANSFER_ORDER_STATE.PICKING],
