...
export const SALES_ORDER_TRANSITIONS: Record<string, string[]> = {
  ...
  [SALES_ORDER_STATE.CONFIRMED]: [SALES_ORDER_STATE.PICKING, SALES_ORDER_STATE.SHIPPED, SALES_ORDER_STATE.INVOICED, SALES_ORDER_STATE.CANCELLED, SALES_ORDER_STATE.QUOTED],
  [SALES_ORDER_STATE.PICKING]: [SALES_ORDER_STATE.SHIPPED, SALES_ORDER_STATE.INVOICED, SALES_ORDER_STATE.QUOTED],
  [SALES_ORDER_STATE.SHIPPED]: [SALES_ORDER_STATE.INVOICED],
  [SALES_ORDER_STATE.INVOICED]: [SALES_ORDER_STATE.SHIPPED, SALES_ORDER_STATE.CONFIRMED, SALES_ORDER_STATE.ARCHIVED],
  [SALES_ORDER_STATE.CANCELLED]: [SALES_ORDER_STATE.DRAFT, SALES_ORDER_STATE.ARCHIVED],
  [SALES_ORDER_STATE.ARCHIVED]: [SALES_ORDER_STATE.CANCELLED, SALES_ORDER_STATE.INVOICED],
};
...
export const PURCHASE_ORDER_TRANSITIONS: Record<string, string[]> = {
  ...
  [PURCHASE_ORDER_STATE.ORDERED]: [PURCHASE_ORDER_STATE.DRAFT, PURCHASE_ORDER_STATE.PARTIALLY_RECEIVED, PURCHASE_ORDER_STATE.RECEIVED, PURCHASE_ORDER_STATE.CANCELLED, PURCHASE_ORDER_STATE.CLOSED_SHORT],
  ...
  [PURCHASE_ORDER_STATE.RECEIVED]: [PURCHASE_ORDER_STATE.INVOICED, PURCHASE_ORDER_STATE.PARTIALLY_RECEIVED, PURCHASE_ORDER_STATE.ORDERED, PURCHASE_ORDER_STATE.ARCHIVED],
  [PURCHASE_ORDER_STATE.INVOICED]: [PURCHASE_ORDER_STATE.ARCHIVED],
  ...
  [PURCHASE_ORDER_STATE.ARCHIVED]: [PURCHASE_ORDER_STATE.CANCELLED, PURCHASE_ORDER_STATE.RECEIVED, PURCHASE_ORDER_STATE.INVOICED, PURCHASE_ORDER_STATE.CLOSED_SHORT],
};
...
export const SHIPMENT_TRANSITIONS: Record<string, string[]> = {
  ...
  [SHIPMENT_STATE.PARTIALLY_RECEIVED]: [SHIPMENT_STATE.RECEIVED, SHIPMENT_STATE.CANCELLED],
...
export const PURCHASE_RETURN_TRANSITIONS: Record<string, string[]> = {
  ...
  [PURCHASE_RETURN_STATE.STAGED]: [PURCHASE_RETURN_STATE.DRAFT, PURCHASE_RETURN_STATE.SHIPPED, PURCHASE_RETURN_STATE.CANCELLED],
  [PURCHASE_RETURN_STATE.SHIPPED]: [PURCHASE_RETURN_STATE.STAGED, PURCHASE_RETURN_STATE.CANCELLED],
...
export const SHIPMENT_LIFECYCLE: Record<string, number> = {
  ...
  [SHIPMENT_STATE.DRAFT]: 1,
  [SHIPMENT_STATE.DISPATCHED]: 2,
  [SHIPMENT_STATE.PARTIALLY_RECEIVED]: 3,
  [SHIPMENT_STATE.RECEIVED]: 4,
};
