...
import { AllCommunityModule, ModuleRegistry, type ColDef, type ColDefField, type GridReadyEvent, type FirstDataRenderedEvent } from 'ag-grid-community';
...
export default function DataGrid<T>({ endpoint, columns, searchPlaceholder, exportFileName }: DataGridProps<T>) {
