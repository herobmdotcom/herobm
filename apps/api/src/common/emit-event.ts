...
const EVENT_TABLE_MAP: Record<string, unknown> = {
  ...
  [EntityType.CONTACT]: masterDataEvents,
  [EntityType.OPPORTUNITY]: masterDataEvents,
  [EntityType.CRM_ACTIVITY]: masterDataEvents,
  [EntityType.PARTNER]: masterDataEvents,
  [EntityType.REFERRER]: masterDataEvents,
  [EntityType.PRODUCT_SUPPLIER]: masterDataEvents,
  [EntityType.ORGANIZATION]: masterDataEvents, // [EntityType.ACTOR] alias
  [EntityType.SHIPMENT]: warehouseEvents,
  [EntityType.TRANSFER_ORDER]: warehouseEvents,
  [EntityType.WAREHOUSE]: warehouseEvents,
  [EntityType.GOODS_RECEIVED]: warehouseEvents,
