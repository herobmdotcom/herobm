  ...
  async findGlobalReturns(query: PaginationQuery) {
    ...
    const baseQuery = sql`
      WITH returns_data AS (
        ...
        LEFT JOIN herobm_core.sales_orders o ON r.sales_order_id = o.sales_order_id
        ...
        LEFT JOIN herobm_core.organizations a2 ON s.organization_id = a2.organization_id
