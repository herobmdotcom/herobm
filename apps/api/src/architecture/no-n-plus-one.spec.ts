...
describe('Architecture - Database Queries (No N+1)', () => {
  ...
  const KNOWN_LEGACY_VIOLATIONS = new Set<string>([
    'inventory/inventory-movement.service.ts:423',
    'inventory/inventory-movement.service.ts:474',
    'inventory/inventory-movement.service.ts:533',
    'inventory/inventory-movement.service.ts:573',
    'inventory/inventory-movement.service.ts:626',
    'inventory/inventory-movement.service.ts:637',
    'inventory/inventory-movement.service.ts:648',
    'inventory/inventory-movement.service.ts:718',
    'inventory/inventory-movement.service.ts:865',
    'inventory/inventory-movement.service.ts:871',
    'inventory/inventory-movement.service.ts:881',
    'inventory/inventory-movement.service.ts:1267',
    'inventory/inventory-movement.service.ts:1274',
    'inventory/inventory-movement.service.ts:1286',
    'inventory/inventory-movement.service.ts:1341',
    'inventory/inventory-movement.service.ts:1418',
    'inventory/inventory-movement.service.ts:1424',
