...
describe('Architecture - Database Queries (No N+1)', () => {
  ...
  const KNOWN_LEGACY_VIOLATIONS = new Set<string>([
    'inventory/inventory-movement.service.ts:332',
    'inventory/inventory-movement.service.ts:383',
    'inventory/inventory-movement.service.ts:428',
    'inventory/inventory-movement.service.ts:468',
    'inventory/inventory-movement.service.ts:520',
    'inventory/inventory-movement.service.ts:558',
    'inventory/inventory-movement.service.ts:598',
    'inventory/inventory-movement.service.ts:602',
    'inventory/inventory-movement.service.ts:683',
    'inventory/inventory-movement.service.ts:689',
    'inventory/inventory-movement.service.ts:699',
    'inventory/inventory-movement.service.ts:1085',
    'inventory/inventory-movement.service.ts:1092',
    'inventory/inventory-movement.service.ts:1104',
    'inventory/inventory-movement.service.ts:1159',
    'inventory/inventory-movement.service.ts:1236',
    'inventory/inventory-movement.service.ts:1242',
    'orders/backorders.service.ts:1154',
    'orders/backorders.service.ts:1237',
    'purchase-orders/purchase-orders-write.service.ts:705',
    'purchase-orders/purchase-orders-write.service.ts:859',
