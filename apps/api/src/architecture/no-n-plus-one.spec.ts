...
describe('Architecture - Database Queries (No N+1)', () => {
  ...
  const KNOWN_LEGACY_VIOLATIONS = new Set<string>([
    'inventory/inventory-movement.service.ts:322',
    'inventory/inventory-movement.service.ts:373',
    'inventory/inventory-movement.service.ts:418',
    'inventory/inventory-movement.service.ts:458',
    'inventory/inventory-movement.service.ts:510',
    'inventory/inventory-movement.service.ts:548',
    'inventory/inventory-movement.service.ts:588',
    'inventory/inventory-movement.service.ts:592',
    'inventory/inventory-movement.service.ts:624',
    'inventory/inventory-movement.service.ts:678',
    'inventory/inventory-movement.service.ts:684',
    'inventory/inventory-movement.service.ts:694',
    'inventory/inventory-movement.service.ts:714',
    'inventory/inventory-movement.service.ts:1095',
    'inventory/inventory-movement.service.ts:1102',
    'inventory/inventory-movement.service.ts:1114',
    'inventory/inventory-movement.service.ts:1169',
    'inventory/inventory-movement.service.ts:1271',
    'inventory/inventory-movement.service.ts:1277',
