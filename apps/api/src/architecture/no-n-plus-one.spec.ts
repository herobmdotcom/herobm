...
describe('Architecture - Database Queries (No N+1)', () => {
  ...
  const KNOWN_LEGACY_VIOLATIONS = new Set<string>([
    ...
    'inventory/inventory-movement.service.ts:691',
    'inventory/inventory-movement.service.ts:701',
    'inventory/inventory-movement.service.ts:721',
    'inventory/inventory-movement.service.ts:1102',
    'inventory/inventory-movement.service.ts:1109',
    'inventory/inventory-movement.service.ts:1121',
    'inventory/inventory-movement.service.ts:1176',
    'inventory/inventory-movement.service.ts:1278',
    'inventory/inventory-movement.service.ts:1284',
