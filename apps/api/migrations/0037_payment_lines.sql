...
ALTER TABLE "herobm_core"."payment_entries" ALTER COLUMN "party_id" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "herobm_core"."payment_lines" ADD CONSTRAINT "payment_lines_gl_account_id_gl_accounts_gl_account_id_fk" FOREIGN KEY ("gl_account_id") REFERENCES "herobm_core"."gl_accounts"("gl_account_id") ON DELETE no action ON UPDATE no action;