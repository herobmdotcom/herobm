...
ALTER TABLE "herobm_core"."purchase_debit_note_lines" ADD COLUMN IF NOT EXISTS "description" text;--> statement-breakpoint
ALTER TABLE "herobm_core"."purchase_debit_note_lines" ADD COLUMN IF NOT EXISTS "account_id" uuid;--> statement-breakpoint
ALTER TABLE "herobm_core"."purchase_debit_note_lines" ADD COLUMN IF NOT EXISTS "tax_category_id" uuid;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "herobm_core"."purchase_debit_note_lines" ADD CONSTRAINT "purchase_debit_note_lines_account_id_gl_accounts_gl_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "herobm_core"."gl_accounts"("gl_account_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
