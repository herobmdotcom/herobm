DO $$ BEGIN
    CREATE TYPE "modbm_core"."fractional_behavior" AS ENUM('allow_fractional', 'round_up', 'round_down', 'force_multiple');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
ALTER TABLE "modbm_core"."product_components" ADD COLUMN IF NOT EXISTS "fractional_behavior" "modbm_core"."fractional_behavior" DEFAULT 'allow_fractional' NOT NULL;
DO $$ BEGIN
