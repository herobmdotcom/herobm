  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col lg:flex-row justify-between lg:items-start">
        ...
        {(hasActions || nav) && (
          <div
            className={`order-1 lg:order-2 flex-col lg:flex-row items-stretch lg:items-center lg:justify-end shrink-0 gap-2 lg:gap-4 ${
              hasActions
                ? 'flex -mx-4 lg:mx-0 px-4 lg:px-0 pb-3 lg:pb-0 border-b lg:border-none border-[rgba(196,198,205,0.2)] mb-3 lg:mb-0'
                : 'hidden lg:flex'
            }`}
          >
