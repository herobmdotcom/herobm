...
export default function SalesQuotesContent() {
  ...
  const [days, setDays, isReady] = usePersistedFilter('sales-quotes-days', '90');
  ...
  return (
    <DataGrid<UnifiedOrder>
      endpoint={isReady ? `/api/sales-orders?days=${days}&state=draft,quoted` : undefined}
      columns={columns}
      gridKey="ops-quotes"
      searchPlaceholder={tSales('placeholders.searchQuotes')}
