          ...
          <div className="overflow-x-auto border border-[var(--border)] rounded-md">
            ...
            <table className="table-lines">
              ...
              <tbody className="bg-white">
                ...
                <tr><td className="font-mono font-medium text-xs text-[var(--brand-navy)]">warehouse</td><td className="text-[var(--text-secondary)] font-mono text-xs">receipt_created, receipt_status_changed, shipment_created, shipment_status_changed, shipment_dispatched, pick_created, pick_cancelled, putaway_completed</td></tr>
                ...
                <tr><td className="font-mono font-medium text-xs text-[var(--brand-navy)]">inventory_ledger</td><td className="text-[var(--text-secondary)] font-mono text-xs">adjustment_processed</td></tr>
