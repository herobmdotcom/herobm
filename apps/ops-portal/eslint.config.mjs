      ...
      'i18next/no-literal-string': ['error', {
        ...
        words: {
          exclude: [
            ...
            /^use client$/,
            /^([a-z]+_[a-z_]+|info|group|delete|edit|phone|smartphone|mail|payments|print|check|settings|tune|close|folder|search|warning|lock|verified|visibility|warehouse|calculate|badge|schedule)$/,
            /^[—\-\.\+←→·%\$\(\)\"\'\,\s\&×•]+$/,
            /^(&times;|&bull;)$/
          ]
        }
