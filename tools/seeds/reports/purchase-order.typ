...
#grid(
  ...
  [
    #grid(
      ...
      text(9pt, weight: "bold", fill: luma(80))[Reference:], if "supplierReference" in data.header and data.header.supplierReference != "" [#data.header.supplierReference] else if "referenceNumber" in data.header and data.header.referenceNumber != "" [#data.header.referenceNumber] else if "customerOrderNumber" in data.header and data.header.customerOrderNumber != "" [#data.header.customerOrderNumber] else [—],
