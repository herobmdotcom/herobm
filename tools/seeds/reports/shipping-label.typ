...
#import "theme-customer.typ": getTheme
...
#set text(font: theme.fontFamily, size: 8pt, fill: theme.primaryColor)
...
#rect(
  ...
  #grid(
    ...
    [
      #text(6pt, weight: "bold", fill: theme.mutedColor)[FROM:] \
      #text(8pt, weight: "bold", fill: theme.primaryColor)[#if orgName != "" [#orgName] else [Fulfillment]] \
      #if orgAddr != "" [#text(7pt)[#orgAddr] \ ]
      #if orgCity != "" or orgState != "" or orgPost != "" [
        #text(7pt)[#orgCity #orgState #orgPost] \
      ]
      #if orgPhone != "" [#text(6.5pt, fill: theme.mutedColor)[Ph: #orgPhone]]
    ],
    [
      #text(6pt, weight: "bold", fill: theme.mutedColor)[SHIPMENT \#] \
      #text(8.5pt, weight: "bold", fill: theme.primaryColor)[#shipmentNumber] \
      #v(0.1cm)
      #text(6.5pt, fill: theme.mutedColor)[Date: #dispatchDate]
    ]
  )
]
...
#rect(
  width: 100%,
  stroke: 1.5pt + theme.primaryColor,
  inset: (x: 8pt, y: 7pt),
  radius: 3pt,
  fill: white,
)[
  #text(6.5pt, weight: "bold", fill: theme.mutedColor)[DELIVER TO:] \
  #v(0.05cm)
  #text(12pt, weight: "bold", fill: theme.primaryColor)[#recipientName] \
  ...
  #v(0.08cm)
    ...
    #v(0.05cm)
    #text(11pt, weight: "bold", fill: theme.primaryColor)[#deliveryCity #if deliveryState != "" [#deliveryState] #if deliveryPostalCode != "" [#deliveryPostalCode]] \
    ...
    #v(0.05cm)
    #text(7.5pt, fill: theme.mutedColor)[Contact: #deliveryPhone]
  ]
]
  ...
  #grid(
    ...
    [
      #grid(
        ...
        row-gutter: 4pt,
        column-gutter: 6pt,
        text(6.5pt, weight: "bold", fill: theme.mutedColor)[Order \#:], text(8pt, weight: "bold", fill: theme.primaryColor)[#orderNumber],
        text(6.5pt, weight: "bold", fill: theme.mutedColor)[Customer PO:], text(7.5pt)[#if customerOrderNumber != "" and customerOrderNumber != none [#customerOrderNumber] else [—]],
        text(6.5pt, weight: "bold", fill: theme.mutedColor)[Units / Lines:], text(7.5pt)[#totalQuantity units (#totalLines lines)],
        text(6.5pt, weight: "bold", fill: theme.mutedColor)[Package:], text(7.5pt, weight: "bold", fill: theme.primaryColor)[1 OF 1],
      )

      #v(0.15cm)
      #text(6.5pt, weight: "bold", fill: theme.mutedColor)[TRACKING \#:] \
      #text(10pt, weight: "bold", fill: theme.accentColor)[#if trackingNumber != "" and trackingNumber != none [#trackingNumber] else [—]]
    ],
    [
      #align(center)[
        #qrcode(barcodePayload, width: 2.2cm)
        #v(0.05cm)
        #text(5.5pt, fill: theme.mutedColor)[#barcodePayload]
      ]
    ]
  )
]
...
// ── SPECIAL INSTRUCTIONS / NOTES ─────────────────────────────────────────────
  ...
  #rect(
    ...
    #text(6pt, weight: "bold", fill: theme.primaryColor)[DELIVERY INSTRUCTIONS:] \
