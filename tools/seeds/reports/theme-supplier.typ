#import "fragment-supplier-header.typ": header as supplierHeader
#import "fragment-supplier-footer.typ": footer as supplierFooter
...
#let conf(title: none, doc) = {
  ...
  set page(
    ...
    header-ascent: 15%,
    footer-descent: 15%,
    header: supplierHeader(orgData, title: title, theme: t),
    footer: supplierFooter(orgData, theme: t)
  )
  doc
}
