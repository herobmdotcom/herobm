// Sales Quote — herobm report template
...
#grid(
  ...
  [
    #grid(
      ...
      text(9pt, weight: "bold", fill: theme.mutedColor)[Customer PO:], if data.header.customerOrderNumber != "" [#data.header.customerOrderNumber] else [—],
